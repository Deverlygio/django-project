...
A comprehensive Django web application for managing livestock and pet stores with inventory management, stores processing, attendance tracking, and more.
...
### 📊 Dashboard
- Today's stores summary
- Total inventory stock
- Low stock alerts (< 5 units)
- Recent stores overview
- Interactive charts (weekly stores, category breakdown)
...
- **New Stores**: When orders are placed
...
- `/dashboard/weekly-stores-data/` - Weekly stores data
- `/dashboard/category-stores-data/` - Stores by category
